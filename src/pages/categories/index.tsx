...
export default function Categories({ posts, mount, letter }: PostPageTypes) {
  const router = useRouter();
  if (router.isFallback) {
    return <Skeleton />;
  }
  const categories = filterAttributes(posts, 'tag');
  return (
    <div>
      <Head>
      ...
      <Attributes attributes={categories} mount={mount} letter={letter} />
    </div>
  );
}
