...
export default function CategoryPostPage({ posts, mount, letter }: PostPageTypes) {
  ...
  return (
    <div>
      <Head>
        <title>The Scions Report - {posts.data[0].attributes.tag.data.attributes.name}</title>
