...
import CategoryPosts from '../../container/Categories';

export default function ExpansionPostPage({ posts, mount, letter }: PostPageTypes) {
  ...
  return (
    <div>
      <Head>
        <title>The Scions Report - {posts.data[0].attributes.category.data.attributes.name}</title>
        <meta name="description" content="Generated by create next app" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <CategoryPosts posts={posts} mount={mount} letter={letter} />
    </div>
  );
}
